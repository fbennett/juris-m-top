...
numbers. The full text of the sample can be found in [Appendix 1:
Sample abbreviation file](#appendix-1-sample-abbreviation-file).
...
The full text of this sample can be found in [Appendix 2:
Sample user interface map file](#appendix-2-sample-user-interface-map-file).

#### File content

> **Lines 2-19 & 20-49:** There are two keys in a Jurism UI map file,
...
The intermediate files described above are generated from a single
source file in the Legal Resource Registry, to which we now turn.

> **Lines 2-57:** There are three top-level keys in an LRR source
> file: `langs`; `courts`: and `jurisdictions`.
...
## Appendix 1: Sample abbreviation file
...
## Appendix 2: Sample user interface map file
